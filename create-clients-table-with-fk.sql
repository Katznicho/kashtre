-- SQL Script to create clients table with foreign key constraints
-- This version should work if branches and businesses tables exist

-- First, let's check if the referenced tables exist
