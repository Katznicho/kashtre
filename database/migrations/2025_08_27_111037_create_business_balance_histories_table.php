...
return new class extends Migration
{
    ...
    {
        Schema::create('business_balance_histories', function (Blueprint $table) {
            $table->id();
            ...
            $table->index(['business_id', 'created_at'], 'business_balance_histories_business_created_idx');
            $table->index(['money_account_id', 'created_at'], 'business_balance_histories_account_created_idx');
            $table->index(['reference_type', 'reference_id'], 'business_balance_histories_reference_idx');
        });
    }
    ...
    {
        Schema::dropIfExists('business_balance_histories');
    }
};
