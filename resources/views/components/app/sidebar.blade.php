                ...
                <ul class="mt-3 space-y-2" x-data="{ openGroup: '' }">
                    ...
                    <li>
                        ...
                        <ul x-show="openGroup === 'business'" x-collapse class="mt-1 space-y-1 pl-10">
                            ...
                            <li><a href="{{ route('branches.index') }}" class="block text-sm text-gray-700 hover:text-blue-700 py-1.5">Manage Branches</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <!-- Items -->
                    <li>
                        <button @click="openGroup === 'items' ? openGroup = '' : openGroup = 'items'" :class="openGroup === 'items' ? 'border border-blue-500 text-blue-700 bg-blue-50' :
                                'text-gray-700 hover:text-blue-700'" class="flex items-center justify-between w-full text-left pl-4 pr-3 py-2 rounded-md">
                    ...
                    <!-- Manage Finance -->
                    <li>
                        <button @click="openGroup === 'finance' ? openGroup = '' : openGroup = 'finance'" :class="openGroup === 'finance' ? 'border border-blue-500 text-blue-700 bg-blue-50' :
                                'text-gray-700 hover:text-blue-700'" class="flex items-center justify-between w-full text-left pl-4 pr-3 py-2 rounded-md">
                        ...
                        <ul x-show="openGroup === 'finance'" x-collapse class="mt-1 space-y-1 pl-10">
                            <li><a href="{{ route('dashboard') }}" class="block text-sm text-gray-700 hover:text-blue-700 py-1.5">Finance Dashboard</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <!-- Clients -->
                    <li>
                        <button @click="openGroup === 'clients' ? openGroup = '' : openGroup = 'clients'" :class="openGroup === 'clients' ? 'border border-blue-500 text-blue-700 bg-blue-50' :
                                'text-gray-700 hover:text-blue-700'" class="flex items-center justify-between w-full text-left pl-4 pr-3 py-2 rounded-md">
                        ...
                        <ul x-show="openGroup === 'clients'" x-collapse class="mt-1 space-y-1 pl-10">
                            <li><a href="{{ route('dashboard') }}" class="block text-sm text-gray-700 hover:text-blue-700 py-1.5">Client
                                    Management</a></li>
                        </ul>
                    </li>
                    ...
                    <!-- Reports -->
                    <li>
                        <button @click="openGroup === 'reports' ? openGroup = '' : openGroup = 'reports'" :class="openGroup === 'reports' ? 'border border-blue-500 text-blue-700 bg-blue-50' :
                                'text-gray-700 hover:text-blue-700'" class="flex items-center justify-between w-full text-left pl-4 pr-3 py-2 rounded-md">
                        ...
                        <ul x-show="openGroup === 'reports'" x-collapse class="mt-1 space-y-1 pl-10">
                            <li><a href="{{ route('dashboard') }}" class="block text-sm text-gray-700 hover:text-blue-700 py-1.5">View Reports</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul x-show="openGroup === 'settings'" x-collapse class="mt-1 space-y-1 pl-10">
                            ...
                            <li><a href="{{ route('sections.index') }}" class="block text-sm text-gray-700 hover:text-blue-700 py-1.5">Manage Sections</a>
                            </li>
                            <li><a href="{{ route('item-units.index') }}" class="block text-sm text-gray-700 hover:text-blue-700 py-1.5">Manage Item Units</a>
                            </li>
                            <li><a href="{{ route('groups.index') }}" class="block text-sm text-gray-700 hover:text-blue-700 py-1.5">Manage Groups</a>
                            </li>
                            <li><a href="{{ route('patient-categories.index') }}" class="block text-sm text-gray-700 hover:text-blue-700 py-1.5">Manage Patient Categories</a>
                            </li>
                            <li><a href="{{ route('suppliers.index') }}" class="block text-sm text-gray-700 hover:text-blue-700 py-1.5">Manage Suppliers</a>
                            </li>
                            <li><a href="{{ route('stores.index') }}" class="block text-sm text-gray-700 hover:text-blue-700 py-1.5">Manage Stores</a>
                            </li>
                            <li><a href="{{ route('insurance-companies.index') }}" class="block text-sm text-gray-700 hover:text-blue-700 py-1.5">Manage Insurance Companies</a>
                            <li><a href="{{ route('sub-groups.index') }}" class="block text-sm text-gray-700 hover:text-blue-700 py-1.5">Manage Sub Groups</a>
                            </li>
