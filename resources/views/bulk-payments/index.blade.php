        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <div class="flex items-center justify-between mb-4">
                    <h2 class="text-xl font-bold text-gray-800 dark:text-white">Bulky Payments</h2>
                ...
                {{-- You can list past bulk payments here --}}
            </div>
        </div>
        ...
        <div x-show="showModal" x-transition.opacity
            ...
            <div @click.away="showModal = false" x-transition
                ...
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-semibold text-gray-800 dark:text-white">Upload Bulky Payments</h3>
                ...
                <form action="{{ route('bulk-payments.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" required
                            ...
                            placeholder="e.g. Staff Salaries July 2025">
                    </div>
                    ...
                    <div>
                        <label for="file" class="block font-medium text-gray-700 dark:text-gray-300">Upload CSV (Phone Number, Amount, Name)</label>
                        <input type="file" name="file" id="file" accept=".csv" required
                            class="mt-1 block w-full text-gray-700 dark:text-white">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Ensure CSV has: `phone_number, amount, name` headers.</p>
                    </div>
